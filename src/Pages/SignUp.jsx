...
export default function SignUp() {
  ...
  return (
    <div className="hero h-[800px] md:h-[1000px] px-4 bg-[url('/3752984_1962410.jpg')]">
      ...
      <div className="rounded flex-shrink-0 w-full max-w-2xl  bg-black/40">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="text-white">
          ...
          <div className="form-control">
            ...
            <input type="text" placeholder="Name" className="input  bg-transparent  border-white/50 rounded-sm" {...register('name',{required: true, minLength: 3, maxLength: 20})} />
          ...
          <div className="form-control">
            ...
            <input type="email" placeholder="Email" className="input  bg-transparent  border-white/50 rounded-sm" {...register('email', {required: true, pattern: /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/ })} />
          ...
          <div className="form-control">
            ...
            <input type="text" placeholder="Password" className="input  bg-transparent  border-white/50 rounded-sm" {...register('password', {required: true, pattern:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[#$@!%&*?])[A-Za-z\d#$@!%&*?]{6,8}$/ })} />
    ...
    multiple {...register('photo',{required: true})} /></div>
          ...
          <div className="form-control mt-6">
            <button className="bg-white/90 py-2 px-3 text-[#014BA0] rounded font-bold transition-all flex justify-center items-center hover:bg-white/80 text-sm md:text-base" type="submit"> {loading? 'Loading' : 'Sign Up '} 
     </button>
          </div>
        </form>
